...
class HybridResNetV2(nn.Module):
    ...
    def forward(self, x):
        ...
        skip_112x112 = nn.functional.interpolate(
            skip_56x56, scale_factor=2, mode="bilinear", align_corners=False
        )
...
class VisionTransformer(nn.Module):
    def __init__(
        self, img_size=224, num_classes=2, zero_head=False, vis=False, pretrained=True
    ):
